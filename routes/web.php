...
/*
|--------------------------------------------------------------------------
| Login Controller --Rutas Asociadas-- 🟡🟡🟡
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Rutas para Medicos --(usuario con credenciales)-- 🟡🟡🟡
|--------------------------------------------------------------------------
*/
Route::middleware(['auth'])->group(function () {
    Route::get('/main', [ReportController::class, 'main'])->name('reports.inicio');
    Route::get('/capture-data', [ReportController::class, 'create'])->name('reports.capture-data');
