...
@section('content')
    ...
    <div class="ContornoReporte">
        ...
        <div class="hoja1">
            <p>
                Corresponde al Instituto Moreliano de Protección Animal, tener en observación por un término de 10 días a
                los animales que se encuentren en supuesto de haber atacado a una o varias personas y/o animales, a fin de
                descartar enfermedad zoonótica y evaluar su conducta y comportamiento.
            </p>
            ...
            <p>
                Por lo que una vez descartada enfermedad zoonótica y haber resultado apto para reintegrarse a su familia o a
                la comunidad, en el dictamen de conducta y comportamiento:
            </p>

            <p><strong>DEVUÉLVASE EJEMPLAR</strong>, quedando apercibido respecto de la reincidencia y sometido a dar
                cumplimiento con las siguientes medidas:</p>

            <div class="form-row">
                <label><input type="checkbox" /> No mantener atado</label>
            </div>
            <div class="form-row">
                <label><input type="checkbox" /> Colocar a ejemplar o ejemplares en un lugar donde puedan cubrirse de las
                    inclemencias del tiempo</label>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <label><input type="checkbox" /> Realizar esquema de salud preventivo y asentar en cartilla de
                    vacunación</label>
            </div>
            <div class="form-row">
                <label><input type="checkbox" /> No dejar salir a la vía pública sin correa y cadenas y solo bajo
                    supervisión</label>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <label><input type="checkbox" /> Se le hace saber al ciudadano propietario o poseedor del ejemplar agresor
                    que NO ES PROCEDENTE LA DEVOLUCIÓN DEL EJEMPLAR por lo siguiente:</label>
            </div>

            <div class="form-row">
                <label><input type="checkbox" /> Presentó sintomatología correspondiente a una enfermedad zoonótica
                    (¿Cuál?):</label>
                <input type="text" class="input-largo" />
            </div>
            ...
            <div class="form-row">
                <label><input type="checkbox" /> No cumplió el propietario o poseedor del ejemplar agresor con los
                    requisitos que acrediten la legal procedencia de la obtención del ejemplar y por no contar con las
                    condiciones de bienestar animal en el domicilio señalado</label>
            </div>
    ...
    <style>
        body {
            .print-spacer {
                display: block;
                height: var(--print-spacer-height, 20px);
                /* valor por defecto */
            }
        }
