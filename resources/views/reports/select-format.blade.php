...
<div class="grupo_tarjetas" style="scroll-behavior: smooth;" onload="history.scrollRestoration='manual'">
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/reporte.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/bitacoraDiaria.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/bitacoraVehicular.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/registroDiario.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/resguardo.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/eutanasia.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/suministros.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/hojaClinica.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/valoracion.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/etograma.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/consentimiento.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/recepcionEjemplares.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/devolucionEjemplares.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/receta.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/certificadoAdopcion.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/donacionEjemplares.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/citatorio.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/inventarioEjemplares.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/esterilizacion.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/acta.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/visita.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/atencionEjemplares.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/resolucionEjemplares.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/encuestaAdopcion.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/encuestaSatisfaccion.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/estetica.png') }}" alt="Reporte">
</div>
...
<div class="formato-item">
  ...
  <img src="{{ asset('images/formatosCaptura/esterilizacionColonias.png') }}" alt="Reporte">
</div>
  </div>
    </div>
